...
class Menu extends Component {
  ...
  render() {
    return (
      ...
      <li className="main">
        <div>
          <Link id="nearby-link" to="/workshops/nearby" onClick={this.clickHandler} ref={ (l) => { this.nearbyLink = l; }}>Nearby Workshops</Link>
          <Link id="preferred-link" to="/workshops/preferred" onClick={this.clickHandler} ref={ (l) => { this.preferredLink = l; }}>Preferred Workshops</Link>
        </div>
      </li>
      <li className="side">
        <div>
